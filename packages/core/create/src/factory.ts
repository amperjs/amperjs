...
import { defaults, renderToFile } from "@kappajs/devlib";
...
export default async (
  ...
  const tsconfigJson = {
    extends: "@kappajs/config/tsconfig.vite.json",
    compilerOptions: {
      paths: {
  ...
  const createSourceFolder = async (
    ...
    if (folder.framework.name === "solid") {
      ...
      Object.assign(devDependencies, {
        "@kappajs/solid-generator": `^${solidGenerator.version}`,
      ...
      generators.push({
        importDeclaration: `import solidGenerator from "@kappajs/solid-generator";`,
      ...
      Object.assign(devDependencies, {
        "@kappajs/react-generator": `^${reactGenerator.version}`,
      ...
      generators.push({
        importDeclaration: `import reactGenerator from "@kappajs/react-generator";`,
